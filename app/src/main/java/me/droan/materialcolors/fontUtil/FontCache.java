package me.droan.materialcolors.fontUtil;
...
import me.droan.materialcolors.Application;
...
public class FontCache {
  ...
  public Typeface get(String fontName) {
    ...
    if (cache.containsKey(fontName)) {
      ...
      Typeface typeface = Typeface.createFromAsset(Application.getAppContext().getAssets(),
